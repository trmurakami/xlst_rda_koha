...
<xsl:if test="$DisplayIconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="livro" class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/book_link.png" title="livro" /> Alterar</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img alt="livro" class="materialtype mt_icon_BK" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" title="livro" /> Texto</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="periódico" class="materialtype mt_icon_CR" src="/intranet-tmpl/prog/img/famfamfam/silk/newspaper.png" title="periódico" /> Recursos continuado</xsl:when>
 ...
 <xsl:when test="$leader6='t'"><img alt="livro" class="materialtype mt_icon_BK" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" title="livro" /> Texto</xsl:when>
 <xsl:when test="$leader6='o'"><img alt="conjunto" class="materialtype mt_icon_MX" src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" title="conjunto" /> Kit</xsl:when>
 <xsl:when test="$leader6='p'"><img alt="materiais mistos" class="materialtype mt_icon_MX" src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" title="materiais mistos" />Materiais mistos</xsl:when>
 <xsl:when test="$leader6='m'"><img alt="arquivo de computador" class="materialtype mt_icon_CF" src="/intranet-tmpl/prog/img/famfamfam/silk/computer_link.png" title="arquivo de computador" /> Arquivo de computador</xsl:when>
 ...
 <xsl:when test="$leader6='k'"><img alt="Fotografia" class="materialtype mt_icon_GR" src="/intranet-tmpl/prog/img/famfamfam/silk/picture.png" /> Fotografia</xsl:when>
 <xsl:when test="$leader6='r'"><img alt="Objeto " class="materialtype mt_icon_OB" src="/intranet-tmpl/prog/img/famfamfam/silk/object.png" title="Objeto " /> Objeto </xsl:when>
