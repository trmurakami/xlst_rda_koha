 ...
 * Pitfalls:
 ...
 <span class="label">Data de copyright: </span>
 </xsl:when>
 </xsl:choose>
 ...
 <xsl:with-param name="langLabel">Idioma do sumário: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 ...
 <xsl:with-param name="langLabel">Idioma das legendas: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:for-each>
 </xsl:if>
